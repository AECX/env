...
hl.bind(mainMod .. " + r", hl.dsp.workspace.toggle_special("notes"))

hl.bind(mainMod .. " + SHIFT + r", hl.dsp.window.move({ workspace = "special:notes" }))
...
hl.bind("CTRL + ALT + k", hl.dsp.exec_cmd("keepassxc"))
hl.bind("CTRL + SHIFT + SPACE", hl.dsp.exec_cmd(cyclekeyboard))
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd(menu))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd(nightlight))
hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd(powermenu))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd(screenshot))

hl.bind("SUPER + N", hl.dsp.exec_cmd("~/env/scripts/notes.sh"))
hl.bind("SUPER + M", hl.dsp.exec_cmd("~/env/scripts/timer.sh"))
